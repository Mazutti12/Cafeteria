<footer class="p-3 bg-dark text-white size-footer">
    <div class="icone-footer">
        <a href="{{route('home')}}" class="d-flex align-items-center mb-2 mb-lg-0 text-white text-decoration-none">
            <img src="style/img/icone_header.png" alt="icone do caffee" class="icone-caffee-footer"><svg
        ...
        <a href="https://www.instagram.com/"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                class="bi bi-instagram icone-footer-right" viewBox="0 0 16 16">
                <path
        ...
        <a href="https://pt-br.facebook.com/"
            class="d-flex align-items-center mb-2 mb-lg-0 text-white text-decoration-none">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                class="bi bi-facebook icone-footer-right" viewBox="0 0 16 16">
                <path
